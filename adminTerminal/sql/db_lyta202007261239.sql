/*
 ...
 Source Schema         : db_lyta

 Target Server Type    : MySQL
 Target Server Version : 80016
 File Encoding         : 65001

 Date: 26/07/2020 12:39:21
*/
...
-- ----------------------------
INSERT INTO `sys_message` VALUES (2, 2, 'test', '景色真好看', '龙门石窟是中国石刻艺术宝库之一，现为世界文化遗产、全国重点文物保护单位、国家AAAAA级旅游景区，位于河南省洛阳市洛龙区伊河两岸的龙门山与香山上。龙门石窟与莫高窟、云冈石窟、麦积山石窟并称中国四大石窟。', NULL);
INSERT INTO `sys_message` VALUES (3, 3, 'lyta', '666啊', '位于洛阳市洛龙区伊河两岸的龙门山与香山上。龙门石窟与莫高窟、云冈石窟、麦积山石窟并称中国四大石窟。龙门石窟开凿于北魏孝文帝年间，之后历经东魏、西魏、北齐、隋、唐、五代、宋等朝代连续大规模营造达400余年之久，南北长达1公里，今存有窟龛2345个，造像10万余尊，碑刻题记2800余品。其中\"龙门二十品\"是书法魏碑精华，褚遂良所书的\"伊阙佛龛之碑\"则是初唐楷书艺术的典范。', '2019-04-02 19:07:36');
INSERT INTO `sys_message` VALUES (4, 2, 'test', '龙门石窟很有文化意义', '龙门石窟淡季门票90元，有三个主要景点，一、西山石窟、东山石窟，二、香山寺、三白园，景区很大，建议游览1天时间，最好自备水和零食，西山石窟规模最大，东山规模较小，香山寺内有蒋介石和宋美龄居住的别墅，值得一看，白园是唐代大诗人白居易的安息地，大多游客游至白园体力都会消耗极大，能上白园的人数较少，因售票处及停车场距离景区有3km，建议来去做景区内电瓶车，会节省体力。', '2019-03-06 03:08:09');
INSERT INTO `sys_message` VALUES (25, 1, 'admin', '很不错的·', '洛阳博物馆位于城市的中轴线上，北临风光旖旎的洛浦公园，南接初具规模的隋唐城遗址植物园。采用\"鼎立天下\"的设计理念，整体建筑外观为大鼎造型，整体建筑外观为大鼎造型，以非对称的空间结构为支撑，借鉴园林手法在方形流线的转折位置设置庭院和采光天井，使空间布局达成动态的均衡。洛阳博物馆展馆包括河洛文明展一个基本陈列和珍宝馆、汉唐陶俑馆、唐三彩馆、石刻馆、书画馆、王绣牡丹艺术馆、牡丹花都特产展七个专题陈列', '2019-04-05 11:08:55');
INSERT INTO `sys_message` VALUES (26, 1, 'admin', '666', '中华文化博大精深', '2019-04-05 19:59:30');
INSERT INTO `sys_message` VALUES (27, 1, 'admin', '厉害了', '牡丹文化节就是好', '2019-04-06 17:39:29');
...
CREATE TABLE `sys_scenic`  (
  ...
  `scenic_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `scenic_img_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `scenic_content` varchar(10240) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `scenic_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
